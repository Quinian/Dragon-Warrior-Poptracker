...
[3585] = {"shield_chain", "progressive"},
    ...
    [9] = {"stones_of_sunlight", "progressive"},
    [10]  = {"silver_harp_display", "progressive"},
    [11] = {"rainbow_drop", "toggle"},
    [12] = {"staff_of_rain", "progressive"},
    [13] = {"erdricks_tablet", "toggle"}, 
    [14] = {"gwaelins_love", "toggle"},     
    [15] = {"ball_of_light", "toggle"},     
